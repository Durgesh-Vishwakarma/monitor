      ...
      <div className="relative z-10">
        ...
        {selectedDevice && <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
              <CameraLiveFeed frame={cameraFrame} photos={photos} onTakePhoto={() => handleCommand('take_photo')} onSwitchCamera={() => handleCommand('switch_camera')} onStopLive={() => handleCommand('camera_live_stop')} />
